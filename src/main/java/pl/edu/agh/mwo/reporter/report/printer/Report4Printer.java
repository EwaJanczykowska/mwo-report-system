...
public class Report4Printer implements IReportPrinter {
    ...
    private static final String[] HEADERS = {"Nazwa zadania", "Liczba godzin", "Nazwa projektu"};
    private static final int[] COLUMNS_WIDTHS = {70, 15, 30};
    ...
    public void printToConsole() {
        ...
        System.out.println("-------------------------------------------------------------------------------------" +
                "-----------------------------------");
        System.out.printf("|  %-70s  |  %-15s  | %-20s  |\n", HEADERS[0], HEADERS[1], HEADERS[2]);
        System.out.println("-------------------------------------------------------------------------------------" +
                "-----------------------------------");
        for (Report4.Record record : report.getTop20()) {
            System.out.printf("|  %-70s  |  %-15s  | %-20s  |\n", record.getTaskName(), record.getHours(), record.getProjectName());
        }
